...
const AnonymousSwitch: React.FC<AnonymousSwitchProps> = (props) => {
    const { setAnonymous } = props;
    if (setAnonymous === undefined) return null;
    return (
    <div className='flex flex-row items-center w-36 pl-4 py-1 bg-white rounded-2xl border border-neutral-400'>
